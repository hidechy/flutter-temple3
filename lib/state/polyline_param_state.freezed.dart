...
abstract class $PolylineParamStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String origin, String destination, String apikey});
}
...
class _$_PolylineParamState implements _PolylineParamState {
  const _$_PolylineParamState(
      {required this.origin, required this.destination, required this.apikey});
  ...
  @override
  String toString() {
    return 'PolylineParamState(origin: $origin, destination: $destination, apikey: $apikey)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, origin, destination, apikey);
...
abstract class _PolylineParamState implements PolylineParamState {
  const factory _PolylineParamState(
      ...
      required final String apikey}) = _$_PolylineParamState;
